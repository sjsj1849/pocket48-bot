...
var editableConfig = map[string]fieldDefinition{
	...
	"DOUYIN_ENABLED":                 {"抖音", "抖音监控", "启用作品、特别关注和 IM 模块", kindBoolean},
	"DOUYIN_POLL_SECONDS":            {"抖音", "作品轮询间隔", "作品检查周期（秒）", kindInteger},
	"DOUYIN_SPECIAL_FOLLOW_ENABLED":  {"抖音", "特别关注同步", "同步指定抖音账号的关注状态", kindBoolean},
	"DOUYIN_SPECIAL_FOLLOW_MINUTES":  {"抖音", "特别关注周期", "同步间隔（分钟）", kindInteger},
	"DOUYIN_SPECIAL_FOLLOW_IDS":      {"抖音", "特别关注账号", "抖音号列表", kindStringList},
