...
export function BrowserSession() {
  ...
  const rfb = useRef<{ disconnect: () => void; scaleViewport: boolean; resizeSession: boolean; viewOnly: boolean } | null>(null)
